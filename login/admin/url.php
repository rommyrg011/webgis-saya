...
<?php
// require('scrapdata/dom.php');
// // Website link to scrap
// $website = 'https://feji.io/';
...
<div class="wrapper">
    <form action="#" autocomplete="off">
      <input type="text" spellcheck="false" name="full_url" placeholder="Masukkan URL yang ingin di persingkat" required>
      ...
      if(mysqli_num_rows($sql2) > 0){;
        ?>
          <div class="statistics">
            ...
            <a href="template/delete.php?delete=all">Clear All</a>
        </div>
        <div class="urls-area">
          <div class="title">
            <li>Shorten URL</li>
          ...
          <?php
            while($row = mysqli_fetch_assoc($sql2)){
              ?>
                ...
                <li><a href="template/delete.php?id=<?php echo $row['shorten_url'] ?>">Delete</a></li>
              </div>
              <?php
            }
          ?>
  ...
  <div class="popup-box">
  <div class="info-box">Tautan pendek Anda sudah siap. Anda juga dapat mengedit tautan pendek Anda sekarang tetapi tidak dapat mengedit setelah Anda menyimpannya.</div>
  <form action="#" autocomplete="off">
    <label>Tautan Pendek Anda</label>
