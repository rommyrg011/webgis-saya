...
shortenBtn.onclick = () => {
  ...
  xhr.open("POST", "template/url-controll.php", true);
  xhr.onload = () => {
    if (xhr.readyState == 4 && xhr.status == 200) {
      ...
      if (data.length <= 5) {
        ...
        //salin url web yang sedang di buka
        let domain = "localhost/webgis/login/admin/";
        ...
        saveBtn.onclick = () => {
          ...
          xhr2.open("POST", "template/save-url.php", true);
          xhr2.onload = () => {
